        ...
        <div className="flex gap-4">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            ...
            <div className="mt-1 grid grid-cols-2 pl-5 pt-1">
              <p className="truncate text-gray-500"> Group: {item.id}</p>
            ...
            <Link href="/user_groups">
              <h2 className="text-medium cursor-pointer pb-4 pl-5 font-bold text-blue-500 hover:text-blue-900 hover:underline">
                View Inventory
              </h2>
            </Link>
          </div>
